...
class IssueTypeApi(object):
    ...
    def GET(self, id=None):
        if id is None:
            ...
            return db.IssueType.get(db.IssueType.id == id).to_json()
...
class IssueApi(object):
    ...
    def GET(self, id=None):
        if id is None:
            ...
            return db.Issue.get(db.Issue.id == id).to_json()
...
class ResponseApi(object):
    ...
    def GET(self, issue=None, id=None):
        ...
        if id is None:
            issue = db.Issue.get(db.Issue.id == issue)
            return db.to_json([
                item.to_dict()
                for item in issue.responses
            ])
        else:
            return db.Response.get(db.Response.id == id).to_json()

@cherrypy.expose
class VoteApi(object):

    def GET(self, response):
        response = db.Response.get(db.Response.id == response)
        return db.to_json([
            item.to_dict()
